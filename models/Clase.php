...
class Clase extends BaseModel {
    ...
    public function obtenerClasesPendientes($estudianteid, $periodo, $depid, $carreraid){
        ...
        return $this->fetchAll($sql, [$estudianteid, $periodo, $estudianteid, $depid, $carreraid]);
    }
