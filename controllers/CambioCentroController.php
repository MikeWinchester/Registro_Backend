...
require_once __DIR__ . "/../models/CambioCentro.php";
require_once __DIR__ . "/BaseController.php";

class CambioCentro extends BaseController{
    private $CC;
    ...
    public function getSolicitudesCentro() {

        // Ejecutamos la consulta
        $result = $this->CC->obtenerSolicitudCentro();
    ...
    public function responderSolicitudCentro() {
